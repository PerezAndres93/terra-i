...
fecha_el_salvador = '2004_01_01_to_2022_04_07'
...
print("También, recuerda borrar el archivo Asc que se encuentra en:")
print("T:\GISDATA_terra\outputs\Latin\2004_01_01_to_2022_04_07\ASCII\decrease\region\classified\Latin_decrease_2004_01_01_to_2022_01_01.asc.gz")
print("T:\GISDATA_terra\outputs\Latin\2004_01_01_to_2022_04_07\ASCII\decrease\region\unclassified\Latin_decrease_2004_01_01_to_2022_01_01.asc")
print("porque se creará nuevamente los archivos anteriormente borrados con los datos actualizados")
print(" ")
...
latin_salvador = "T://GISDATA_terra//outputs//Latin//" + fecha_el_salvador + "//TIFF//GEOGRAPHIC//WGS84//decrease//region" + classify + "latin_elsalvador_" + fecha_el_salvador + ".tif"
latin_salvador_ahuachapan = r"T://GISDATA_terra//outputs//Latin//" + fecha_lat + "//TIFF//GEOGRAPHIC//WGS84//decrease//region" + classify + "latin_elsalvador_ahuachapan_" + fecha_lat + ".tif"
latin_salvador_ahuachapan_valle = r"T://GISDATA_terra//outputs//Latin//" + fecha_lat + "//TIFF//GEOGRAPHIC//WGS84//decrease//region" + classify + "latin_elsalvador_ahuachapan_valle_" + fecha_lat + ".tif"
latin_salvador_ahuachapan_valle_honduras = r"T://GISDATA_terra//outputs//Latin//" + fecha_lat + "//TIFF//GEOGRAPHIC//WGS84//decrease//region" + classify + "latin_elsalvador_ahuachapan_valle__honduras_" + fecha_lat + ".tif"
...
print(latin)
elsalvador = r"T:/GISDATA_terra/outputs/el_salvador/" + fecha_el_salvador + "/TIFF/GEOGRAPHIC/WGS84/decrease/region" + classify + "elsalvador_decrease_" + fecha_el_salvador + ".tif" 
print(elsalvador)
...
ahuachapan1 = ExtractByAttributes(ahuachapan, "VALUE <> 1")
#ahuachapan1.save("T://GISDATA_terra//outputs//ahuachapan//" + fecha_ahuachapan + "//TIFF//GEOGRAPHIC//WGS84//decrease//region" + classify + "ahuachapan_decrease_" + fecha_el_salvador + "_sin0.tif")
honduras1 = ExtractByAttributes(honduras, "VALUE <> 1")
#honduras1.save("T://GISDATA_terra//outputs//HONDURAS//" + fecha_honduras + "//TIFF//GEOGRAPHIC//WGS84//decrease//region" + classify + "honduras_decrease_" + fecha_honduras + "_sin0.tif")
...
resultado0.save(latin_salvador)

print("Uniendo ahuachapan a latin...")
resultado1 = Con(IsNull(ahuachapan1), resultado0, ahuachapan1)
resultado1.save(latin_salvador_ahuachapan)

print("Uniendo valle a latin...")
resultado2 = Con(IsNull(valle), resultado1, valle)
resultado2.save(latin_salvador_ahuachapan_valle)

print("Uniendo honduras a latin...")
resultado3 = Con(IsNull(honduras1), resultado2, honduras1)
resultado3.save(latin_salvador_ahuachapan_valle_honduras)
